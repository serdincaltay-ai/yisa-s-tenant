/**
 * Instagram Entegrasyon API
 * GET  — Tenant'ın Instagram konfigürasyonunu döner
 * POST — Instagram hesabı bağla / güncelle
 * Kullanım: @besiktasjktuzlasporokulu gibi hesapları yönetmek için
 */
...
export async function GET() {
  ...
  if (error) {
    console.error('[social/instagram] GET error:', error)
  ...
  return NextResponse.json({
    ...
    defaults: {
      platform: 'instagram',
      account_name: '@besiktasjktuzlasporokulu',
      features: [
        'Otomatik DM yanıtlama',
        'Hikaye paylaşım zamanlama',
        'Yorum moderasyonu',
        'Lead toplama (DM → demo_requests)',
