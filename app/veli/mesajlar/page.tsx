  ...
  return (
    <div className="min-h-screen bg-zinc-950 pb-20">
      ...
      <main className="p-4 space-y-4">
        ...
        <p className="text-sm text-zinc-400">Antrenör ile iletişim — çocuğunuzun antrenörüyle canlı mesajlaşın.</p>
        ...
        {loading && !selectedPartner ? (
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
            ...
            <p className="text-sm text-zinc-400 mb-4">Çocuğunuzun antrenörüyle canlı mesajlaşın.</p>
            {partners.length === 0 ? (
